...
using Fase06RepositoryCsv.Tests;
...
namespace Fase06RepositoryCsv
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            TestesRepositorioCsv.ExecutarTodos();
            ...
            Console.WriteLine("--- Cenario 2: Listagem de Livros (CSV) ---");
            ...
            Console.WriteLine("--- Cenario 3: Campos com Virgulas e Aspas ---");
            ...
            Console.WriteLine("--- Cenario 6: Persistencia em CSV ---");
            Console.WriteLine("Os dados foram salvos em books.csv");
            Console.WriteLine("Execute novamente e verá que os dados persistem!\n");

            // Mostrar conteúdo do arquivo CSV
            Console.WriteLine("--- Conteudo do Arquivo CSV ---");
            if (File.Exists(path))
            {
