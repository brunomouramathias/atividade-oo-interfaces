...
using Fase07RepositoryJson.Tests;
...
namespace Fase07RepositoryJson
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            TestesRepositorioJson.ExecutarTodos();
            ...
            Console.WriteLine("--- Cenario 2: Listagem de Livros (JSON) ---");
            ...
            Console.WriteLine("--- Cenario 3: Caracteres Especiais em JSON ---");
            ...
            // Cenário 6: Persistência entre execuções
            Console.WriteLine("--- Cenario 6: Persistencia em JSON ---");
            Console.WriteLine("Os dados foram salvos em books.json");
            Console.WriteLine("Execute novamente e verá que os dados persistem!\n");

            // Mostrar conteúdo do arquivo JSON
            Console.WriteLine("--- Conteudo do Arquivo JSON ---");
            if (File.Exists(path))
            {
